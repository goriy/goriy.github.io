...
BLOG_AUTHOR = "None"  # (translatable)
BLOG_TITLE = "Some stuff"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://goriy.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://goriy.github.io/"
BLOG_EMAIL = "none@example.com"
BLOG_DESCRIPTION = "I don't really know what is it"  # (translatable)
...
# LICENSE = """
#<br/>
#Все материалы доступны по <a rel="license" href="http://creativecommons.org/licenses/by/4.0/">лицензии Creative Commons «Attribution» («Атрибуция») 4.0 Всемирная</a>.
#CC-BY.
#"""
...
CONTENT_FOOTER = '{date} - Powered by         <a href="https://getnikola.com" rel="nofollow">Nikola</a>         {license}'
